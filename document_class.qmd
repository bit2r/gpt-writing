...
book_front_pdf <- book_pdf[1:12]
book_back_pdf <- book_pdf[13:24]

book_front_stack <- book_front_pdf |> 
  image_resize(geometry = "800x") |> 
  image_append(stack=FALSE)
...
image_append(c(book_front_stack, book_back_stack), stack=TRUE)
```
